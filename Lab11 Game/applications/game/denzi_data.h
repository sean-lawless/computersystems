...
#define CHARACTER_FINLEY     211

void ItemTileDisplay(u32 x, u32 y, u32 color, int tileIndex);
void PlayerTileDisplay(u32 x, u32 y, u32 color, int tileIndex);
void SpriteTileDisplay(u32 x, u32 y, u32 color, int tileIndex);
void BackgroundTileDisplay(u32 x, u32 y, u32 color, int tileIndex);
